...
import './Footer.css';
import NewsletterPic from '../../assets/images/newsletter.png';
                    ...
                    <div className="row align-items-center">
                        <div className="col-5">
                            <div className="footer-top-data d-flex gap-30 align-items-center">
                                <img src={NewsletterPic} alt="newsletter"/>
                    ...
                    <div className="row">
                        <div className="col-4">
                            ...
                            <div>
                                ...
                                <a className="mt-3 d-block mb-1 text-white" href="tel:+91 8264954234">
                                    +91 8264954234
                                </a>
                                <a className="mt-2 d-block mb-0 text-white" href="mailto:gonihales1234@gmail.com">
                                    gonihales1234@gmail.com
                                </a>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <p className="text-center mb-0 text-white">
                                &copy; {new Date().getFullYear()} Powered by Osman Goni
                            </p>
                        </div>
                    </div>
                </div>
